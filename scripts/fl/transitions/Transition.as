package fl.transitions
{
	...
	public class Transition extends EventDispatcher
	{
		...
		public function Transition(param1:MovieClip, param2:Object, param3:TransitionManager)
		{
			...
			this.duration#1 = param2.duration;
		...
		public function set duration#1(param1:Number) : void
		{
			if(param1)
			{
		...
		private function _resetTween() : void
		{
			...
			this._twn = new Tween(this,"",this.easing,0,1,this.duration#1,true);
			this._twn.stop();
