package anifire.player.skins
{
	...
	public class VolumeHSliderSkin extends SparkSkin implements IBindingClient, IStateClient2
	{
		...
		public var _VolumeHSliderSkin_Rect1:Rect;
		...
		public function VolumeHSliderSkin()
		{
			...
			var bindings:Array = this._VolumeHSliderSkin_bindingsSetup();
			var watchers:Array = [];
			target = this;
			if(_watcherSetupUtil == null)
			{
				watcherSetupUtilClass = getDefinitionByName("_anifire_player_skins_VolumeHSliderSkinWatcherSetupUtil");
			...
			{
				return VolumeHSliderSkin[param1];
			},bindings,watchers);
			mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
			mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
			this.minHeight = 22;
			this.mxmlContent = [this._VolumeHSliderSkin_Button1_i(),this._VolumeHSliderSkin_Rect1_i(),this._VolumeHSliderSkin_Group1_i(),this._VolumeHSliderSkin_Button2_i()];
			this.currentState = "normal";
			this._VolumeHSliderSkin_ClassFactory1_i();
			states = [new State({
				"name":"normal",
				"overrides":[]
			}),new State({
		...
		{
			VolumeHSliderSkin._watcherSetupUtil = param1;
		}
		...
		private function _VolumeHSliderSkin_ClassFactory1_i() : ClassFactory
		{
			var _loc1_:ClassFactory = new ClassFactory();
			_loc1_.generator = VolumeHSliderSkinInnerClass0;
		...
		private function _VolumeHSliderSkin_Button1_i() : Button
		{
		...
		private function _VolumeHSliderSkin_Rect1_i() : Rect
		{
			...
			_loc1_.radiusY = 2;
			_loc1_.height = 5;
			_loc1_.fill = this._VolumeHSliderSkin_SolidColor1_c();
			_loc1_.initialized(this,"_VolumeHSliderSkin_Rect1");
			this._VolumeHSliderSkin_Rect1 = _loc1_;
			BindingManager.executeBindings(this,"_VolumeHSliderSkin_Rect1",this._VolumeHSliderSkin_Rect1);
			return _loc1_;
		}
		
		private function _VolumeHSliderSkin_SolidColor1_c() : SolidColor
		{
		...
		private function _VolumeHSliderSkin_Group1_i() : Group
		{
			var _loc1_:Group = new Group();
			_loc1_.left = 0;
			_loc1_.top = 0;
			_loc1_.bottom = 0;
			_loc1_.mxmlContent = [this._VolumeHSliderSkin_Rect2_c()];
			_loc1_.id = "trackMask";
			if(!_loc1_.document)
			{
				_loc1_.document = this;
		...
		private function _VolumeHSliderSkin_Rect2_c() : Rect
		{
			var _loc1_:Rect = new Rect();
			_loc1_.left = 0;
			_loc1_.right = 0;
			_loc1_.top = 0;
			_loc1_.bottom = 0;
			_loc1_.fill = this._VolumeHSliderSkin_SolidColor2_c();
			_loc1_.initialized(this,null);
			return _loc1_;
		}
		
		private function _VolumeHSliderSkin_SolidColor2_c() : SolidColor
		{
			var _loc1_:SolidColor = new SolidColor();
		...
		private function _VolumeHSliderSkin_Button2_i() : Button
		{
			var _loc1_:Button = new Button();
			_loc1_.top = 0;
			_loc1_.bottom = 0;
		...
		private function _VolumeHSliderSkin_bindingsSetup() : Array
		{
			var result:Array = [];
			result[0] = new Binding(this,null,null,"_VolumeHSliderSkin_Rect1.mask","trackMask");
