package anifire.sound
{
	...
	public class NetStreamController extends EventDispatcher
	{
		...
		public function NetStreamController(param1:Number)
		{
			...
			this.addPlayHeadCommand(new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_PAUSE,0));
		}
		...
		private function addPlayHeadCommand(param1:PlayHeadCommand#54) : void
		{
			...
			var _loc3_:PlayHeadCommand = new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_SEPERATOR,0);
			this.playHeadCommands.push(param1);
			this.playHeadCommands.push(_loc3_);
			if(param1.playHeadCommand == PlayHeadCommand#54.PLAYHEAD_COMMAND_SEEK)
			{
				_loc4_ = new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_SEPERATOR,0);
				_loc5_ = new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_SEPERATOR,0);
				if(this.playHeadStatus == PLAYHEAD_STATUS__PAUSED)
				{
					this.playHeadCommands.push(new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_RESUME));
					this.playHeadCommands.push(_loc4_);
					this.playHeadCommands.push(new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_PAUSE));
		...
		private function execPlayHeadCommand() : void
		{
			...
			{
				_loc1_ = this.playHeadCommands.shift() as PlayHeadCommand#54;
				if(_loc1_.playHeadCommand == PlayHeadCommand#54.PLAYHEAD_COMMAND_PAUSE)
				{
					this.netStream.addEventListener(NetStatusEvent.NET_STATUS,this.doExecOnPauseReady);
					this.netStream.pause();
				}
				else if(_loc1_.playHeadCommand == PlayHeadCommand#54.PLAYHEAD_COMMAND_RESUME)
				{
					this.netStream.addEventListener(NetStatusEvent.NET_STATUS,this.doExecOnResumeReady);
					this.netStream.resume();
				}
				else if(_loc1_.playHeadCommand == PlayHeadCommand#54.PLAYHEAD_COMMAND_SEEK)
				{
		...
		public function resume() : void
		{
			if(this.netConnectionStatus == CONNECT_STATE__CONNECTED)
			{
				...
				this.addPlayHeadCommand(new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_RESUME));
			}
		...
		public function pause() : void
		{
			if(this.netConnectionStatus == CONNECT_STATE__CONNECTED)
			{
				this.addPlayHeadCommand(new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_PAUSE));
			}
		...
		public function seek(param1:Number) : void
		{
			...
			{
				_loc2_ = 0.2;
				this.addPlayHeadCommand(new PlayHeadCommand#54(PlayHeadCommand#54.PLAYHEAD_COMMAND_SEEK,param1));
			}
		}
...
class PlayHeadCommand#54
{
	...
	function PlayHeadCommand#54(param1:int, param2:Number = 0)
	{
		super();
