package
{
   import anifire.player.components.GoPlayerPreloader;
   ...
   public class _player_mx_managers_SystemManager extends SystemManager implements IFlexModuleFactory, ISWFContext
   {
      ...
      override public function info() : Object
      {
         ...
         {
            this._info = {
               "applicationComplete":"onApplicationCompleted()",
               ...
               "compiledResourceBundleNames":["SharedResources","components","containers","controls","core","effects","formatters","layout","skins","sparkEffects","styles","utils"],
               ...
               "mixins":["_player_FlexInit","_player_Styles","mx.messaging.config.LoaderConfig"],
